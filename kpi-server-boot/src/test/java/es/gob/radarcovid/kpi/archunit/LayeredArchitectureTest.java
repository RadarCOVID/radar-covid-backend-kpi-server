 ...
 */
package es.gob.radarcovid.kpi.archunit;
...
public class LayeredArchitectureTest {
    ...
    static final ArchRule layer_dependencies_are_respected = layeredArchitecture()
            ...
            .layer("Batchs").definedBy("es.gob.radarcovid..batch..")
            ...
            .whereLayer("Batchs").mayNotBeAccessedByAnyLayer()
            .whereLayer("Services").mayOnlyBeAccessedByLayers("Controllers", "Batchs")
