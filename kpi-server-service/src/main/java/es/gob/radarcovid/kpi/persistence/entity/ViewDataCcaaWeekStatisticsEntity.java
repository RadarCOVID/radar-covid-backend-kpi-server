...
@Builder
@Entity
@Table(name = "VIEW_DATA_CCAA_WEEK_STATISTICS")
public class ViewDataCcaaWeekStatisticsEntity implements Serializable {
	...
	private ViewDataCcaaWeekStatisticsIdEntity id;
