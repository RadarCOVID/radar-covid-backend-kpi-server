...
@Builder
@Entity
@Table(name = "VIEW_DATA_CCAA_MONTH_STATISTICS")
public class ViewDataCcaaMonthStatisticsEntity implements Serializable {
	...
	@AttributeOverrides({
        ...
        @AttributeOverride(name="ccaaId", column=@Column(name="CCAA_ID", nullable = false))
	 })
	private ViewDataCcaaMonthStatisticsIdEntity id;

    @Column(name = "YEAR_MONTH")
    private Integer yearMonth;

    @Column(name = "CCAA_NAME")
