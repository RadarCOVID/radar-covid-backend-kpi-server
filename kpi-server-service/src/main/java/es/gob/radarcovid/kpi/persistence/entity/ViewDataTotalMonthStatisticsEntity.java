...
@Builder
@Entity
@Table(name = "VIEW_DATA_TOTAL_MONTH_STATISTICS")
public class ViewDataTotalMonthStatisticsEntity implements Serializable {
	...
	private ViewDataTotalMonthStatisticsIdEntity id;
